	...
	, eventDistributor(eventDistributor_)
{
	...
	eventDistributor.registerEventListener(
		EventType::KEY_DOWN, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::KEY_UP, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::MOUSE_MOTION, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::MOUSE_BUTTON_DOWN, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::MOUSE_BUTTON_UP, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::MOUSE_WHEEL, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::JOY_BUTTON_DOWN, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::JOY_BUTTON_UP, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::JOY_AXIS_MOTION, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::JOY_HAT, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::WINDOW, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::FILE_DROP, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::OSD_CONTROL_RELEASE, *this, PRIORITY);
	eventDistributor.registerEventListener(
		EventType::OSD_CONTROL_PRESS, *this, PRIORITY);
}
...
void HotKey::initDefaultBindings()
{
	...
	if constexpr (META_HOT_KEYS) {
		...
		bindDefault(HotKeyInfo(KeyDownEvent::create(SDLK_t, KMOD_GUI),
		                       "toggle fastforward", false, false, true));
