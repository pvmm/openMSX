...
public:
	struct FileInfo {
		FileInfo(std::string f, std::string e, SymbolFile::Type t, int s, int ss, int ba)
			: filename(std::move(f)), error(std::move(e)), type(t), slot(s), subslot(ss), base(ba) {} // clang-15 workaround
