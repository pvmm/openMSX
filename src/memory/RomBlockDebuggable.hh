...
protected:
        struct Debuggable : SimpleDebuggable {
                explicit Debuggable(MSXMotherBoard& motherBoard_, std::string name_, static_string_view description_)
			: SimpleDebuggable(
				motherBoard_,
				name_,
				description_,
        ...
        struct DebuggableExt final : Debuggable {
                explicit DebuggableExt(MSXMotherBoard& motherBoard_, std::string name_, static_string_view description_)
